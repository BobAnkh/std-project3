...
def resnet20(input_channel, pretrained=False, num_class=10):
    model = ResNet_CIFAR10(input_channel, BasicBlock, [3, 3, 3, 3], num_class)
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['resnet20']))
    return model


def resnet32(input_channel, pretrained=False, num_class=10):
    model = ResNet_CIFAR10(input_channel, BasicBlock, [5, 5, 5, 5], num_class)
    if pretrained:
...
def resnet302(input_channel, pretrained=False, num_class=10):
    model = ResNet_CIFAR10(input_channel, Bottleneck, [50, 50, 50, 50], num_class)
    if pretrained:
